...
library ChainlinkLib {
  ...
  bytes4 internal constant coordinatorRequestDataFid = bytes4(keccak256("executeServiceAgreement(address,uint256,uint256,bytes32,address,bytes4,bytes32,bytes)"));
